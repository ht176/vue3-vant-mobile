...
export class CostBalanceServiceProxy extends ServiceProxyBase {
     ...
     * @return Success
     */
    chargeNotice(patientId: string | undefined, startDate: dayjs.Dayjs | undefined, endDate: dayjs.Dayjs | undefined, source: string | undefined , cancelToken?: CancelToken | undefined): Promise<CostListRecordViewResultEntry> {
...
export class RoomItemListServiceProxy extends ServiceProxyBase {
     ...
     * @return Success
     */
    filter8(filter: string | undefined, key: string | undefined, batch: boolean | undefined , cancelToken?: CancelToken | undefined): Promise<InventoryViewResult> {
...
export class RoomRecordInServiceProxy extends ServiceProxyBase {
     ...
     * @return Success
     */
    getRoomRecordBatch(roomItemListId: string , cancelToken?: CancelToken | undefined): Promise<RoomRecordBatchViewResult> {
        let url_ = this.baseUrl + "/api/RoomRecordIn/GetRoomRecordBatch/{roomItemListId}";
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response: AxiosResponse) => this.processGetRoomRecordBatch(_response));
        });
    }

    protected processGetRoomRecordBatch(response: AxiosResponse): Promise<RoomRecordBatchViewResult> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (const k in response.headers) {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200  = _responseText;
            result200 = RoomRecordBatchViewResult.fromJS(resultData200);
            return Promise.resolve<RoomRecordBatchViewResult>(result200);

        } else if (status !== 200 && status !== 204) {
            const _responseText = response.data;
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        }
        return Promise.resolve<RoomRecordBatchViewResult>(null as any);
    }
}
...
export class CostBalanceView implements ICostBalanceView {
    ...
    toJSON(data?: any) {
        ...
        data["surplusCount"] = this.surplusCount;
        data["id"] = this.id;
        data["lastRechargeTime"] = this.lastRechargeTime ? this.lastRechargeTime.toLocaleString() : <any>undefined;
        data["lastDeductionTime"] = this.lastDeductionTime ? this.lastDeductionTime.toLocaleString() : <any>undefined;
        data["creater"] = this.creater;
        data["createId"] = this.createId;
        data["createTime"] = this.createTime ? this.createTime.toLocaleString() : <any>undefined;
        data["updater"] = this.updater;
...
/** 耗材批次余量明细 */
export class RoomRecordBatchView implements IRoomRecordBatchView {
    /** 批次 */
    batchNo?: string | undefined;
    /** 余量 */
    balance?: number;
    ...
    constructor(data?: IRoomRecordBatchView) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): RoomRecordBatchView {
        data = typeof data === 'object' ? data : {};
        let result = new RoomRecordBatchView();
        result.init(data);
        return result;
    }
...
/** 耗材批次余量明细 */
export interface IRoomRecordBatchView {
    /** 批次 */
    batchNo?: string | undefined;
    /** 余量 */
    balance?: number;
...
/** Reponse */
export class RoomRecordBatchViewResult implements IRoomRecordBatchViewResult {
    /** 请求是否成功 */
    success?: boolean;
    /** 错误码 */
    code?: string | undefined;
    ...
    url?: string | undefined;
    /** 返回数据封装 */
    data?: RoomRecordBatchView[] | undefined;

    constructor(data?: IRoomRecordBatchViewResult) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["data"])) {
                this.data = [] as any;
                for (let item of _data["data"])
                    this.data!.push(RoomRecordBatchView.fromJS(item));
            }
        }
    }

    static fromJS(data: any): RoomRecordBatchViewResult {
        data = typeof data === 'object' ? data : {};
        let result = new RoomRecordBatchViewResult();
        result.init(data);
        return result;
    }
...
/** Reponse */
export interface IRoomRecordBatchViewResult {
    /** 请求是否成功 */
    success?: boolean;
    /** 错误码 */
    code?: string | undefined;
...
export class RoomRecordFaultyItemEditModel implements IRoomRecordFaultyItemEditModel {
    ...
    toJSON(data?: any) {
        ...
        data["count"] = this.count;
        data["cause"] = this.cause;
        data["faultyTime"] = this.faultyTime ? this.faultyTime.toLocaleString() : <any>undefined;
        data["remark"] = this.remark;
        return data;
    }
}
...
export class RoomRecordInEditModel implements IRoomRecordInEditModel {
    ...
    toJSON(data?: any) {
        ...
        data["roomItemListId"] = this.roomItemListId;
        data["inTime"] = this.inTime ? this.inTime.toLocaleString() : <any>undefined;
        data["count"] = this.count;
        data["surplusCount"] = this.surplusCount;
        data["batchNo"] = this.batchNo;
        data["productionDate"] = this.productionDate ? this.productionDate.toLocaleString() : <any>undefined;
        data["expiryDate"] = this.expiryDate ? this.expiryDate.toLocaleString() : <any>undefined;
...
export class RoomRecordInventoryItemEditModel implements IRoomRecordInventoryItemEditModel {
    ...
    remark?: string | undefined;
    /** 盘点耗材批次明细 */
    roomRecordInventoryItemBatches?: RoomRecordInventoryItemBatchEditModel[] | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.remark = _data["remark"];
            if (Array.isArray(_data["roomRecordInventoryItemBatches"])) {
                this.roomRecordInventoryItemBatches = [] as any;
                for (let item of _data["roomRecordInventoryItemBatches"])
                    this.roomRecordInventoryItemBatches!.push(RoomRecordInventoryItemBatchEditModel.fromJS(item));
            }
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["remark"] = this.remark;
        if (Array.isArray(this.roomRecordInventoryItemBatches)) {
            data["roomRecordInventoryItemBatches"] = [];
            for (let item of this.roomRecordInventoryItemBatches)
                data["roomRecordInventoryItemBatches"].push(item.toJSON());
        }
        return data;
    }
}
...
export class RoomRecordInventoryItemView implements IRoomRecordInventoryItemView {
    ...
    batchManage?: number | undefined;
    /** 批次明细 */
    recordInventoryItemBatchViews?: RoomRecordInventoryItemBatchView[] | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.updateTime = _data["updateTime"] ? dayjs(_data["updateTime"].toString()) : <any>undefined;
            this.batchManage = _data["batchManage"];
            if (Array.isArray(_data["recordInventoryItemBatchViews"])) {
                this.recordInventoryItemBatchViews = [] as any;
                for (let item of _data["recordInventoryItemBatchViews"])
                    this.recordInventoryItemBatchViews!.push(RoomRecordInventoryItemBatchView.fromJS(item));
            }
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["actualCount"] = this.actualCount;
        data["remark"] = this.remark;
        data["inventoryDate"] = this.inventoryDate ? this.inventoryDate.toLocaleString() : <any>undefined;
        data["billNo"] = this.billNo;
        data["roomItemTypeName"] = this.roomItemTypeName;
        data["name"] = this.name;
        data["shortName"] = this.shortName;
        ...
        data["updateTime"] = this.updateTime ? this.updateTime.toLocaleString() : <any>undefined;
        data["batchManage"] = this.batchManage;
        if (Array.isArray(this.recordInventoryItemBatchViews)) {
            data["recordInventoryItemBatchViews"] = [];
            for (let item of this.recordInventoryItemBatchViews)
                data["recordInventoryItemBatchViews"].push(item.toJSON());
        }
        return data;
    }
}
...
export class RoomRecordOutItemView implements IRoomRecordOutItemView {
    ...
    toJSON(data?: any) {
        ...
        data["patientId"] = this.patientId;
        data["roomRecordInId"] = this.roomRecordInId;
        data["outTime"] = this.outTime ? this.outTime.toLocaleString() : <any>undefined;
        data["groupId"] = this.groupId;
        data["count"] = this.count;
        data["factCount"] = this.factCount;
...
export class RoomRecordRestoreItemEditModel implements IRoomRecordRestoreItemEditModel {
    ...
    toJSON(data?: any) {
        ...
        data["cause"] = this.cause;
        data["remark"] = this.remark;
        data["restoreTime"] = this.restoreTime ? this.restoreTime.toLocaleString() : <any>undefined;
        return data;
    }
}
